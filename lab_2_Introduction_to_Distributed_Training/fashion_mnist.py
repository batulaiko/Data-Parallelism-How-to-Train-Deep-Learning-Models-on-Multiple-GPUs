...
def worker(local_rank,args):
    ...
    dist.init_process_group(backend='nccl',
                            ...
                            rank=global_rank ) # https://docs.pytorch.org/docs/stable/distributed.html
    ...
    dist.barrier() # https://docs.pytorch.org/docs/stable/distributed.html#torch.distributed.barrier
    ...
    train_sampler = torch.utils.data.distributed.DistributedSampler(train_set,
                                                                    ...
                                                                    rank=global_rank) # https://github.com/pytorch/pytorch/blob/81322aee7452cd081c8d10f0f27609c8ba1f4bb4/torch/utils/data/distributed.py
    ...
    train_loader = torch.utils.data.DataLoader(train_set, 
                                               batch_size=args.batch_size, drop_last=True, sampler=train_sampler) # https://docs.pytorch.org/docs/stable/data.html
    ...
    model = torch.nn.SyncBatchNorm.convert_sync_batchnorm(WideResNet(num_classes)).to(device) # https://docs.pytorch.org/docs/stable/generated/torch.nn.SyncBatchNorm.html#torch.nn.SyncBatchNorm.convert_sync_batchnorm
    ...
    model = nn.parallel.DistributedDataParallel(model,device_ids=[local_rank])                # https://docs.pytorch.org/docs/stable/notes/ddp.html#distributeddataparallel
    ...
    for epoch in range(args.epochs):
        ...
        train_sampler.set_epoch(epoch) # Step 6.5
        ...
        images_per_sec = torch.tensor(len(train_loader)*args.batch_size/epoch_time).to(device) # from len(train_loader)*args.batch_size/epoch_time
        
        torch.distributed.reduce(images_per_sec, 0) # Step 8
...
if __name__ == '__main__':
    torch.multiprocessing.spawn(worker, nprocs=args.num_gpus, args=(args,)) # https://docs.pytorch.org/docs/stable/multiprocessing.html#module-torch.multiprocessing.spawn